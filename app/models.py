...
app = Flask(__name__)
app.config["SQLALCHEMY_DATABASE_URI"] = "mysql+pymysql://root:yanxi76543210@127.0.0.1/movie"
...
class Userlog(db.Model):
    ...
    addtime = db.Column(db.DateTime, index=True, default=datetime.now)  # 登录时间, UTC(协调世界时)时间
...
# if __name__ == '__main__':
    ...
    admin = Admin(
        name="yourusername",
        pwd=generate_password_hash("yourpassword"),
        is_super=0,
        role_id=1
    )
